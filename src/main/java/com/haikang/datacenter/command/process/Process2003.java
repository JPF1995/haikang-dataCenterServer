...
import com.haikang.common.messagebody.Message0x8003;
...
public class Process2003 extends CommandProcess {

    @Override
    public CommandMessage transformData(String sim, int messageID, String[] param) {
        CommandMessage message = new Message0x8003();
        ...
        message.setCmd(0x8003);
        message.setSim(sim);
        message.setMessageID(messageID);
        ((Message0x8003) message).setDriverIdList(driverIDList);
